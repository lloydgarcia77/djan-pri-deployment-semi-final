...
class PRIApplicantProfileInfo(models.Model):
    ...
    #Person to notify
    contact_person = models.CharField(max_length=100, verbose_name="Contact Person Name", null=True)
    relationship = models.CharField(max_length=100, null=True )
    contact_person_mobile_no = models.CharField(max_length=100, unique=True, null=True)
    ...
    weight = models.DecimalField(default=0, max_digits=5, decimal_places=2, verbose_name="Weight (Lbs)")
    height = models.DecimalField(default=0, max_digits=5, decimal_places=2, verbose_name="Height (Inch)")
    shirt_size = models.DecimalField(default=0, max_digits=5, decimal_places=2)
    shoe_size = models.DecimalField(default=0, max_digits=5, decimal_places=2)
    waistline = models.DecimalField(default=0, max_digits=5, decimal_places=2)
    length_of_pants = models.DecimalField(default=0, max_digits=5, decimal_places=2)
...
class PRIApplicantSibilingsInfo(models.Model):
    applicant_siblings = models.ForeignKey(PRIApplicantProfileInfo, on_delete=models.CASCADE, related_name='siblings_applicant_fk')
...
class PRIApplicantEmploymentHistoryInfo(models.Model):
    applicant_employment_history = models.ForeignKey(PRIApplicantProfileInfo, on_delete=models.CASCADE, related_name='employment_applicant_fk')
    ...
    basic_salary_pay = models.DecimalField(default=0, max_digits=12, decimal_places=2)
...
class PRIApplicantTrainingsInfo(models.Model):
    applicant_trainings = models.ForeignKey(PRIApplicantProfileInfo, on_delete=models.CASCADE, related_name='tranings_applicant_fk')
...
class PRIApplicantCharacterReferencesInfo(models.Model):
    ...
    applicant_character_references = models.ForeignKey(PRIApplicantProfileInfo, on_delete=models.CASCADE, related_name='character_references_applicant_fk')
